...
insert into Especie (id,nombre,descripcion,foto,genero_id) values (10,'Bufo bufo','Sapo Común','https://upload.wikimedia.org/wikipedia/commons/8/81/Bufo_bufo_03.jpg',7);
insert into Especie (id,nombre,descripcion,foto,genero_id) values (11,'Epidalea calamita','Sapo corredor','https://upload.wikimedia.org/wikipedia/commons/thumb/3/39/Epidalea_calamita_01_by-dpc.jpg/1200px-Epidalea_calamita_01_by-dpc.jpg',8);
insert into Especie (id,nombre,descripcion,foto,genero_id) values (12,'Pelobates cultripes','Sapo de espuelas','https://static.inaturalist.org/photos/46513345/large.jpg',9);
insert into Especie (id,nombre,descripcion,foto,genero_id) values (13,'Hyla meridionalis','Ranita meridional','https://1.bp.blogspot.com/-AQoPkPs2sHU/UhCO-JxFflI/AAAAAAAAGtE/qWd9WZ_TDCk/s1600/IMG_8169.jpg',10);
insert into Especie (id,nombre,descripcion,foto,genero_id) values (14,'Pleurodelest Waltl','Gallipato','https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/Pleurodeles_waltl_BUD.jpg/1280px-Pleurodeles_waltl_BUD.jpg',11);
insert into Especie (id,nombre,descripcion,foto,genero_id) values (15,'Salamandra Salamandra','Salamandra común','https://misanimales.com/wp-content/uploads/2021/01/salamandra-musgo.jpg',12);
insert into Especie (id,nombre,descripcion,foto,genero_id) values (16,'Tarentola mauritanica','Salamanquesa común','https://static.inaturalist.org/photos/21873580/large.jpeg',13);
insert into Especie (id,nombre,descripcion,foto,genero_id) values (17,'Hemidactylus turcicus','Salamanquesa rosada','https://inaturalist-open-data.s3.amazonaws.com/photos/171801218/large.jpg',14);
insert into Especie (id,nombre,descripcion,foto,genero_id) values (18,'Psammodromus algirus','Lagartija colilarga','https://upload.wikimedia.org/wikipedia/commons/thumb/6/6c/Psammodromus_algirus_2601.jpg/1280px-Psammodromus_algirus_2601.jpg',15);
insert into Especie (id,nombre,descripcion,foto,genero_id) values (19,'Natrix Maura','Culebra viperina','https://www.montesdevalsain.es/images/Natmau4_a.jpg',16);
insert into Especie (id,nombre,descripcion,foto,genero_id) values (20,'Natrix natrix','Culebra de collar','https://www.fishipedia.es/wp-content/uploads/2021/04/34888189801_2182df33f2_h.jpeg',16);
insert into Especie (id,nombre,descripcion,foto,genero_id) values (21,'Zamenis scalaris','Culebra de escalera','https://www.vertebradosibericos.org/reptiles/identificacion/rhiscaid1.jpg',17);
insert into Especie (id,nombre,descripcion,foto,genero_id) values (22,'Buthus occitanus','alacrán','https://granadanatural.com/imagenes/fauna_fichas/buthus-occitanus-1.jpg',18);
insert into Especie (id,nombre,descripcion,foto,genero_id) values (23,'Buthus ibericus','alacrán ibérico','https://www.biodiversidadvirtual.org/insectarium/data/media/9033/Buthus-ibericus-1-de-2-972736.jpg',18);
insert into Especie (id,nombre,descripcion,foto,genero_id) values (24,'Herpestes ichneumon','Meloncillo','https://cazaworld.com/wp-content/uploads/2018/10/Meloncillo.jpg',19);
