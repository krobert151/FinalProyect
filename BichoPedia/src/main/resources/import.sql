...
insert into Usuario (id_usuario,nombre,apellidos,correo,username,passwd,fechaNac,administrator) values (1,'Roberto','Rebolledo Naharro', 'robertorebolledo151@gmail.com', 'krobert151','krobert151','2004-10-12',true);
...
--insert into Encuentro (id,usuario_id,especie_id,fecha,descripcion,foto,zona,tamanio,peso,sexo) values (1,1,1,'2023-01-01T12:30:30','fotito','Gerena',10,5,'f');
